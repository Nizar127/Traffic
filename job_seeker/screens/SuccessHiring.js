...
export default class SuccessHiring extends Component {
    ...
    getCollection = (querySnapshot) => {
        ...
        querySnapshot.forEach((res) => {
            const { jobCreatorID, job_creator_name, job_creator_Image, jobSeekerName, jobSeekerID, jobDescription, job_seekerImage, jobName,job_seekerSalary, type_of_job, task } = res.data();
            jobs.push({
                key: res.id,
                res,
                jobCreatorID,
                        ...
                        renderItem={({ item, index }) => {
                            return (
                                <ListItem key={index}
                                    ...
                                    onPress={() => {
                                        this.props.navigation.navigate('SuccessHiringDetails', {
                                            userkey: item.key
                                        });
                                    }}>
                                    <Left>
